...
#    Jun 04, 2020 10:24:54 AM EDT  platform: Linux
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        font10 = "-family {Bitstream Charter} -size 8"
        ...
        photo_location = os.path.join(prog_location,"./src/logo.png")
        global _img0
        ...
        photo_location = os.path.join(prog_location,"./src/scan.png")
        global _img1
        ...
        photo_location = os.path.join(prog_location,"./src/stop.png")
        global _img2
        ...
        self.Label4.place(relx=0.5, rely=1.0, height=21, width=1847)
        ...
        self.Label5.place(relx=0.77, rely=0.169, height=21, width=124)
